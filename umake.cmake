...
if (${CMAKE_CXX_COMPILER_ID} STREQUAL Clang)
    set(CXX_MODULES_FOR_CHECK -fmodules-ts)
    set(CXX_MODULES_FLAGS -fmodules-ts -std=c++20)
...
elseif (${CMAKE_CXX_COMPILER_ID} STREQUAL GNU)
    message(FATAL_ERROR "GCC does not support c++ 20 modules yet")
...
if (NOT CXX_MODULES_SUPPORTED)
    message(FATAL_ERROR "${CMAKE_CXXCOMPILER_ID} doesn't support C++ 20 modules.")
endif ()
